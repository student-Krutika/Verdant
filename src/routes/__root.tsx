  ...
  head: () => ({
    meta: [
      ...
      { title: "Verdant — Indoor Plants Delivered to Your Door" },
      {
        name: "description",
        content:
          "Hand-picked, air-purifying indoor plants delivered to your door. Greener homes, calmer minds.",
      },
      { name: "author", content: "Verdant" },
      { property: "og:title", content: "Verdant — Indoor Plants" },
      { property: "og:description", content: "Hand-picked indoor plants delivered to your door." },
